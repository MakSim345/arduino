...
int segA = 9; //A1; //Display pin 14
int segB = 7; //3; //Display pin 16
int segC = 5; //4; //Display pin 13
int segD = 3; //5; //Display pin 3
int segE = 4; //A0; //Display pin 5
int segF = 8; //7; //Display pin 11
int segG = 6;  //8; //Display pin 15
